...
pub const KAMINO_FLASHLOAN_AMOUNT: u64 =1_000_000_000;
...
pub fn get_kamino_flashloan_borrow_ix(
    ...
    Ok(Instruction {
        ...
        accounts,
        data: FlashBorrowReserveLiquidity::instruction_data(max_amount*KAMINO_FLASHLOAN_AMOUNT),
    })
}
...
pub fn get_kamino_flashloan_repay_ix(
    ...
    Ok(Instruction {
        ...
        data: FlashRepayReserveLiquidity::instruction_data(
            max_amount*KAMINO_FLASHLOAN_AMOUNT,
